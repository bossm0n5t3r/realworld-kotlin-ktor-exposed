...
class UsersRepositoryTest {
    ...
    @Test
    fun testFindUserEntityByEmail() = runBlocking {
        // Given
        val username = "testuser"
        val email = "test@example.com"
        val hashedPassword = "hashedpassword123"
    ...
    @Test
    fun testFindUserEntityByUsername() = runBlocking {
        // Given
        val username = "testuser"
        val email = "test@example.com"
        val hashedPassword = "hashedpassword123"
    ...
    @Test
    fun testGetUserEntityById() = runBlocking {
        // Given
        val username = "testuser"
        val email = "test@example.com"
        val hashedPassword = "hashedpassword123"
        ...
        // Get the user's ID
        val userId =
            usersRepository.findUserEntityByEmail(email)?.id?.value?.toString()

...
class TagsRepositoryTest {
    ...
    @Test
    fun testGetOrCreateTag_CreateNewTag() = runBlocking {
        // Given
        val tagName = "newtag"
    ...
    @Test
    fun testGetOrCreateTag_GetExistingTag() = runBlocking {
        // Given
    ...
    @Test
    fun testCreateArticleTagEntity() = runBlocking {
        // Given
        val tagName = "testtag"
        val tagEntity = tagsRepository.getOrCreateTag(tagName)
    ...
    @Test
    fun testGetTagOrNull_ExistingTag() = runBlocking {
        // Given
        val tagName = "existingtag"
    ...
    @Test
    fun testGetTagOrNull_NonExistingTag() = runBlocking {
        // Given
    ...
    @Test
    fun testGetAllTagsByArticle() = runBlocking {
        // Given
        val tagNames = listOf("tag1", "tag2", "tag3")
        val tagEntities = tagNames.map { tagsRepository.getOrCreateTag(it) }
        ...
        tagEntities.forEach { tagEntity ->
            assert(retrievedTags.any { it.id == tagEntity.id }) {
                "Expected tag '${tagEntity.tagName}' not found in result"
            }
        }
    }

    @Test
    fun testIsArticleHasTag_True() = runBlocking {
        // Given
        val tagName = "testtag"
        val tagEntity = tagsRepository.getOrCreateTag(tagName)
    ...
    @Test
    fun testIsArticleHasTag_False() = runBlocking {
        // Given

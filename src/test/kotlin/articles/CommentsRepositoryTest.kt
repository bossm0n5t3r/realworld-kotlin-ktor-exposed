...
class CommentsRepositoryTest {
    ...
    fun testGetCommentsForArticle() = runBlocking {
        ...
        commentBodies.forEach { body -> assertTrue(comments.any { it.body == body }) }
        comments.forEach { comment -> assertEquals(articleEntity.id, comment.articleId) }
    }
    ...
    @Test
    fun testGetCommentsForArticle_NoComments() = runBlocking {
        // Given
    ...
    @Test
    fun testGetCommentsForArticle_MultipleUsers() = runBlocking {
        // Given
        // Create another user
        ...
        val comment1 =
            commentsRepository.createComment(userEntity, articleEntity, "Comment from user 1")
        val comment2 =
